<template>
  ...
  <svg v-else-if="iconName === 'paperclip'" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-paperclip"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>
  
  <svg v-else-if="iconName === 'emoji'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16px" height="16px" viewBox="0 0 24 24" version="1.1">
...
<svg v-else-if="iconName === 'cardS'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="17px" height="17px" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 70 70" style="enable-background:new 0 0 70 70;" xml:space="preserve">
	<path class="st0" fill='#172b4d' d="M35.3,14.2c6.4,0,12.7,0,19.1,0c5,0,7.2,2.1,7.3,6.9c0.1,9.2,0.1,18.5,0,27.7c0,4.9-2.3,7-7.2,7   c-13,0-26,0-39,0c-5.1,0-7.2-2.1-7.3-7.3c0-9,0-18,0-27c0-5.3,2.2-7.3,7.6-7.4C22.4,14.2,28.9,14.2,35.3,14.2z M34.9,38.2   c6.1,0,12.2-0.1,18.4,0c2.2,0,3.1-0.6,3-3c-0.2-4.2-0.1-8.5,0-12.7c0.1-2.2-0.9-2.7-2.9-2.7c-12.4,0.1-24.7,0.1-37.1,0   c-1.9,0-2.7,0.6-2.6,2.6c0.1,4.4,0.1,8.7,0,13.1c-0.1,2.2,0.8,2.8,2.9,2.7C22.7,38.1,28.8,38.2,34.9,38.2z M23.3,43.8c-2,0-4,0-6,0   c-2,0-3.4,0.9-3.5,3c-0.1,2.1,1.2,3.2,3.3,3.3c4,0.1,8,0.1,12,0c1.9,0,3.1-1.2,3.1-3c0-2.1-1.2-3.2-3.3-3.3   C27,43.8,25.1,43.8,23.3,43.8z M56.2,46.8c-0.3-2-1.4-3.1-3.5-3c-1.9,0.1-3,1.4-2.9,3.3c0.1,2.1,1.4,3.2,3.5,3   C55.3,50,56.2,48.8,56.2,46.8z"/>
</svg>
<svg v-else-if="iconName === 'cardB'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 70 70" style="enable-background:new 0 0 70 70;" xml:space="preserve">
	<path class="st0" fill='#172b4d' d="M35.3,14.2c6.4,0,12.7,0,19.1,0c5,0,7.2,2.1,7.3,6.9c0.1,9.2,0.1,18.5,0,27.7c0,4.9-2.3,7-7.2,7   c-13,0-26,0-39,0c-5.1,0-7.2-2.1-7.3-7.3c0-9,0-18,0-27c0-5.3,2.2-7.3,7.6-7.4C22.4,14.2,28.9,14.2,35.3,14.2z M34.9,38.2   c6.1,0,12.2-0.1,18.4,0c2.2,0,3.1-0.6,3-3c-0.2-4.2-0.1-8.5,0-12.7c0.1-2.2-0.9-2.7-2.9-2.7c-12.4,0.1-24.7,0.1-37.1,0   c-1.9,0-2.7,0.6-2.6,2.6c0.1,4.4,0.1,8.7,0,13.1c-0.1,2.2,0.8,2.8,2.9,2.7C22.7,38.1,28.8,38.2,34.9,38.2z M23.3,43.8c-2,0-4,0-6,0   c-2,0-3.4,0.9-3.5,3c-0.1,2.1,1.2,3.2,3.3,3.3c4,0.1,8,0.1,12,0c1.9,0,3.1-1.2,3.1-3c0-2.1-1.2-3.2-3.3-3.3   C27,43.8,25.1,43.8,23.3,43.8z M56.2,46.8c-0.3-2-1.4-3.1-3.5-3c-1.9,0.1-3,1.4-2.9,3.3c0.1,2.1,1.4,3.2,3.5,3   C55.3,50,56.2,48.8,56.2,46.8z"/>
</svg>

<svg v-else-if="iconName === 'real-activity'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 70 70" width="24px" height="24px" fill='#292929' style="enable-background:new 0 0 70 70;" xml:space="preserve">
<g>
	<path class="st0" d="M43.4,20.3c-5.2,0-10.4,0-15.6,0c-2,0-3.9-0.4-4-2.7c-0.1-2.3,1.7-2.8,3.8-2.8c10.8,0,21.6,0,32.3,0   c2.1,0,3.9,0.5,3.8,2.8c-0.1,2.3-2,2.7-4,2.7C54.3,20.2,48.9,20.3,43.4,20.3z"/>
	<path class="st0" d="M43.6,43.6c-5.2,0-10.4,0-15.6,0c-2.1,0-4.2-0.3-4.2-2.8c0-2.3,2-2.7,4-2.7c10.6,0,21.3,0,31.9,0   c2,0,3.9,0.4,4,2.7c0,2.6-2,2.9-4.1,2.8C54.3,43.5,49,43.6,43.6,43.6z"/>
	<path class="st0" d="M39.1,31.9c-3.7,0-7.5,0-11.2,0c-2,0-3.9-0.4-4-2.7c-0.1-2.3,1.8-2.8,3.8-2.8c7.9,0,15.7,0,23.6,0   c2,0,3.9,0.5,3.8,2.8c-0.1,2.3-2,2.7-4,2.7C47,31.9,43.1,31.9,39.1,31.9z"/>
	<path class="st0" d="M39.8,49.7c3.8,0,7.5,0,11.3,0c2,0,3.9,0.3,4,2.7c0.1,2.3-1.7,2.8-3.8,2.8c-7.9,0-15.7,0-23.6,0   c-2.1,0-3.9-0.5-3.8-2.8c0.1-2.3,2-2.7,4-2.7C31.8,49.8,35.8,49.7,39.8,49.7z"/>
	<path class="st0" d="M17.3,20.6c-0.1,2.9-2.8,5.6-5.7,5.5c-2.9-0.1-5.5-2.8-5.4-5.8c0.1-3,2.8-5.6,5.6-5.5   C14.8,14.9,17.3,17.6,17.3,20.6z"/>
	<path class="st0" d="M17.3,43.8c-0.1,2.9-2.8,5.6-5.6,5.5c-2.8-0.1-5.5-2.8-5.4-5.7c0.1-2.9,2.8-5.6,5.6-5.5   C14.7,38.2,17.3,41,17.3,43.8z"/>
</g>
</svg>
